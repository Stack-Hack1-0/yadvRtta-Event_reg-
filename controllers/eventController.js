...
const transporter = nodemailer.createTransport(sendgridTransport({
  auth: {
    api_key: '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'
  }
}));
...
exports.getPass = catchAsync(async(req, res, next) => {
  ...
  pdfDoc.fontSize(15).fillColor('black').text('Pass No.  '+  event._id);
